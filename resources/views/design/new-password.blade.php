              ...
              <div class="col-md-12">
                    <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item active" aria-current="page">كود تغير كلمه المرور</li>
                            </ol>
                          </nav>
        ...
        <div class="col-md-12">
            <div class="article-content shadow">
                <p class="content">
                    ...
                    <form method="POST" action="{{url(route('new-password'))}}" validate>
                        {{csrf_field()}}
                            <div class="form-group">
                              <input type="text" class="form-control" name="pin_code" id="validationCustom01" placeholder="كود التحقيق" required>
                                <div class="invalid-feedback">
                                    Please provide a valid phone number.
                                </div>
                            </div>
                            <div class="form-group">
                              <input type="password" class="form-control" name="password" id="validationCustom02" placeholder="كلمة المرور الجديده" required>
                                <div class="invalid-feedback">
                                    Please provide a valid  password .
                                </div>
                            </div>
                            <div class="form-group">
                                <input type="password" class="form-control" name="password_confirmation" id="validationCustom03" placeholder="تاكيد كلمة المرور الجديده" required>
                                <div class="invalid-feedback">
                                    Please provide a valid  password confirmation.
                                </div>
                            </div>
                            <div class="form-btns">
                            <button type="submit" class="btn btn-login">تغير كلمه المرور </button>
                            </div>
                          </form>
            </div>
        </div>
