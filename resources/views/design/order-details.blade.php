      ...
      <div class="container">
          ...
          <div class="col-md-6">
              <div class="input-group mb-2">
                ...
                <input type="text" class="form-control bg-white" id="inlineFormInputGroup" value="{{$record->client->name}}" disabled>
              </div>
              <div class="input-group mb-2">
                  <div class="input-group-prepend">
                    <div class="input-group-text">العمر</div>
                  </div>
                  <input type="text" class="form-control bg-white" id="inlineFormInputGroup" value="{{$record->age}}" disabled>
                </div>
                <div class="input-group mb-2">
                    <div class="input-group-prepend">
          ...
          <div class="col-md-6">
              <div class="input-group mb-2">
                  ...
                  <input type="text" class="form-control bg-white" id="inlineFormInputGroup" value="{{$record->BloodType->name}}" disabled>
                </div>
                <div class="input-group mb-2">
                    <div class="input-group-prepend">
...
<div class="row bg-white">
<div class="col-md-12">
<P class="details-text" id="app1">{{$settings->about_app}}</P>
