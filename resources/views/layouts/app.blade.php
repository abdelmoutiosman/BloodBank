...
{{--          </li>--}}
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{url(route('categorie.index'))}}"><i class="fa fa-circle-o"></i> Categories</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-list"></i> <span>Governorates</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{url(route('governorate.index'))}}"><i class="fa fa-circle-o"></i>Governotates</a></li>
            <li><a href="{{url(route('city.index'))}}"><i class="fa fa-circle-o"></i>Cities</a></li>
          </ul>
        </li>
        <li><a href="{{url(route('client.index'))}}"><i class="fa fa-user"></i> <span>Clients</span></a>
        <li><a href="{{url(route('order.index'))}}"><i class="fa fa-first-order"></i> <span>Orders</span></a></li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2016 <a href="#">Abdelmouti Osman</a>.</strong> All rights
    reserved.
  </footer>
