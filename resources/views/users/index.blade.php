    ...
    <section class="content">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">{{__('messages.List Of Users')}}</h3>
            ...
            <div class="box-body">
                <a href="{{url(route('user.create'))}}" class="btn btn-lg bg-primary"><i class="fa fa-plus"></i> {{__('messages.New user')}}</a>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr class="bg-info">
                                    ...
                                    <th class="text-center">{{__('messages.Roles list')}}</th>
